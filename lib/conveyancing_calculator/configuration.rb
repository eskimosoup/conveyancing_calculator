module ConveyancingCalculator
  ...
  class Configuration
    ...
    attr_writer :sale_fee_bands,
                :purchase_fee_bands,
                :additional_costs,
                :additional_static_costs
    ...
    def additional_static_costs
      raise ConveyancingCalculator::ConfigurationError, 'Additional static costs have not been set' if @additional_static_costs.nil?
      @additional_static_costs
    end
  end
end
